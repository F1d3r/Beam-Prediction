...
preprocessed_lidar_path=[
    ["/efs/data/preprocess_lidar/Adaptation_dataset_multi_modal/scenario31/",
     "/efs/data/preprocess_lidar/Multi_Modal_Test/scenario31/"],
    ["/efs/data/preprocess_lidar/Adaptation_dataset_multi_modal/scenario32/",
     "/efs/data/preprocess_lidar/Multi_Modal/scenario32/",
     "/efs/data/preprocess_lidar/Multi_Modal_Test/scenario32/"],
    ["/efs/data/preprocess_lidar/Adaptation_dataset_multi_modal/scenario33/",
     "/efs/data/preprocess_lidar/Multi_Modal/scenario33/",
     "/efs/data/preprocess_lidar/Multi_Modal_Test/scenario33/"],
    ["/efs/data/preprocess_lidar/Multi_Modal/scenario34/",
    ...
    for lidar_path_idx in range(len(lidar_path[scenario_idx])):
        ...
        for lidar_item in lidar_list: 
            ...
            for point_item in pcd.points:
                ...
                filter_distance=filter_distance_min + (filter_distance_max-filter_distance_min)
                *(point_distance/lidar_distance_cst)**4    
